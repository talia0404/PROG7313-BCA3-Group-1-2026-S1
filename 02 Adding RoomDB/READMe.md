...
Right now, when someone registers, nothing is actually saved anywhere. If the app closes, the account disappears like a skipped leg day promise.
...
Clean architecture matters, even in student projects. If the structure is messy now, future you will be fighting for survival by Part 3.

Your package structure should begin to look something like this:

```text
com.example.sportsync
│
├── data
├── viewmodel
├── ui
