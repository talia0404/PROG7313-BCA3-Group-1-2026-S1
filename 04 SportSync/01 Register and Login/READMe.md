...
This means the app does not open another Activity. Instead, it simply changes which composable is visible.
...
Never build more logic on top of a broken navigation flow. That’s how bugs start paying rent.
...
After that, you will begin building the core **SportSync** features such as:

• sport selection  
• switching between athlete mode and gym mode  
• workout tracking  
